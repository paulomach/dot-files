...
-- nnn bindings
vim.api.nvim_set_keymap('n', '<leader>ff', [[<cmd>NnnExplorer %:p:h<CR>]], { noremap = true, silent = true })
...
-- diagnostic
vim.api.nvim_set_keymap('n', '<S-t>', [[<cmd>TroubleToggle<CR>]], { noremap = true, silent = true })

-- tabmove
vim.api.nvim_set_keymap('', '<C-PageDown>', [[<cmd>tabnext<CR>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('', '<C-PageUp>', [[<cmd>tabprev<CR>]], { noremap = true, silent = true })

-- buffers
vim.api.nvim_set_keymap('', '<A-b>', [[<cmd>Telescope buffers<CR>]], { noremap = true, silent = true })

-- copilot
vim.api.nvim_set_keymap('n', '<leader>cp', [[<cmd>Copilot<CR>]], { noremap = true, silent = true })
-- vim.api.nvim_set_keymap('i', '<C-j>', [[<cmd>lua require('copilot').copilot#Accept()<CR>]], { noremap = true, silent = true })
